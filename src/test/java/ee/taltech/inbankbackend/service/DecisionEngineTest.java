...
class DecisionEngineTest {
    ...
    private String underAgePersonPersonalCode;
    ...
    void setUp() {
        ...
        underAgePersonPersonalCode = "51001206812";
    ...
    void testSegment1PersonalCode() throws InvalidLoanPeriodException, NoValidLoanException,
            InvalidPersonalCodeException, InvalidLoanAmountException, InvalidPersonAgeException {
    ...
    @Test
    void testUnderAgedPerson(){
        assertThrows(InvalidPersonAgeException.class,
                () -> decisionEngine.calculateApprovedLoan(underAgePersonPersonalCode, 2000L, 12, "Latvia"));
    }

    @Test
    void testPersonAgeWithLoanPeriodOverExpectedLifetime(){
        assertThrows(InvalidPersonAgeException.class,
                () -> decisionEngine.calculateApprovedLoan(segment2PersonalCode, 2000L, 12, "Latvia"));
    }
